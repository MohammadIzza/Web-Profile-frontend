          ...
          return (
            ...
            >
              ...
              <button
                ...
                className={`
                  w-32 lg:w-40 px-4 py-6 flex flex-col items-center justify-center gap-2
              ...
              {/* Content Panel */}
              {isActive && (
                <div className="w-screen lg:w-[800px] max-w-full border-t border-line bg-paper">
                  <div className="p-6 lg:p-8 max-h-[70vh] overflow-y-auto scrollbar-hide">
                    {item.loading ? (
                      <div className="py-8">
