    ...
    <section className="border-b border-line py-8 md:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <div className="text-center">
          ...
          {/* Title */}
          {profile.title && (
            <p className="text-base md:text-lg text-ink/70 mb-4 font-serif">
              {profile.title}
            </p>
          )}
          ...
          {/* Bio */}
          {profile.bio && (
            <p className="text-base text-ink/80 max-w-xl mx-auto mb-6 leading-relaxed font-serif">
              {profile.bio}
            </p>
          )}
          
          {/* Contact Info */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-sm text-ink/60 font-serif">
            {profile.email && (
